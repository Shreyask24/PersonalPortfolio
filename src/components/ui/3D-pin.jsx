...
export const PinContainer = ({
    ...
    return (
        <a
            className={cn("relative group/pin z-50 max-sm:mt-48 cursor-pointer", containerClassName)}
            ...
            <div
                ...
                <div
                    ...
                    className="absolute left-1/2 p-2 max-sm:mt-28 top-1/2 flex justify-start items-start rounded-2xl shadow-[0_8px_16px_rgb(0_0_0/0.4)] bg-black border border-white/[0.3] group-hover/pin:border-white/[0.2] transition duration-700 overflow-hidden">
